...
<body class="fixed-top-navbar top-nav  ">
    ...
    try {
        ...
        const response = await fetch('./getrandomaudio.php'); // Replace with the path to your PHP file
        ...
        return randomFile; // Return the selected file path
    } catch (error) {
...
// Prevent the default form submission
        ...
        // Get random audio file path
        let randomAudioFilePath =  getRandomFile(); // Await the result of getRandomFile()

        if (randomAudioFilePath) {
            // Append the random audio file path to the FormData object if available
            formData.append("randomAudioPath", randomAudioFilePath);
        }

        // Check if the audio file input exists and is appended correctly
        if (!formData.has('audioFile')) {
            console.error('Audio file input is missing.');
        }
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light p-0">
                            <div class="change-mode">
                                <div class="custom-control custom-switch custom-switch-icon custom-control-indivne">
                                    ...
                                    <div id="logout">
                                    <form style="margin-right: 5px;" action="./Audio_Manager/main/index.php">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="https://templates.iqonic.design/" id="submit-schedule">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="audioFile_pop" id="audioFile_pop" accept=".mp3,audio/*"  />
                                </div>
...
// Assuming your function to get a random audio file path returns the path as a string

/// Function to fetch files and randomly select one
